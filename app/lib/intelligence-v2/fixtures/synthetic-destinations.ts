...
export const EXPENSIVE_BUT_EXCELLENT_LIFESTYLE: SyntheticDestinationFixture = {
  ...
  financial: {
    ...
    pensionTreatment: "TAXABLE",
    socialSecurityTreatment: "FAVORABLE",
    iraTreatment: "UNKNOWN",
    retirementAccount401kTreatment: "UNKNOWN",
...
/** Layer 4 test fixture: pension/SS/IRA/401(k) each carry a genuinely distinct treatment, proving Layer 4 never collapses them into one "retirement income is tax-friendly" judgment. */
export const LAYER4_TEST_RETIREMENT_TREATMENT_DIFFERENTIATION: SyntheticDestinationFixture = {
  id: "fixture-layer4-retirement-treatment-differentiation",
  displayName: "Fixture: Layer 4 Test — Retirement Treatment Differentiation",
  notes: "Pension favorable, Social Security taxable, IRA unknown, 401(k) treaty-dependent — four distinct retirement-income findings.",
  entryAndStay: {
    touristEntryAllowed: "YES",
    touristStayLimitDays: 90,
    extendedStayOrLongStayVisaAvailable: "YES",
  ...
  cost: {
    estimatedMonthlyCostRange: { low: 2500, high: 3200, currencyCode: "USD" },
    householdSizeAssumedForEstimate: 1,
  },
  financial: {
    taxResidencyTriggerDays: 150,
    pensionTreatment: "FAVORABLE",
    socialSecurityTreatment: "TAXABLE",
    iraTreatment: "UNKNOWN",
    ...
    wealthTaxApplicable: "NO",
    propertyTaxAnnualRatePercent: 0.4,
    propertyPurchaseOrTransferTaxPercent: 6,
    buyVsRentBreakEvenYears: 6,
  },
  lifestyleDimensions: { dimensionValues: {} },
};
