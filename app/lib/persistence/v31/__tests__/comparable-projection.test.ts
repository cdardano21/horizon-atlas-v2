...
describe("Phase 3A.1 comparable projection", () => {
  ...
  it("projects canonical and stored state through the same semantic seam", () => {
    ...
    const storedFixture = {
      ...
      scores: [{ scoreKey: "score-1" as StoredDestinationState["scores"][number]["scoreKey"], scoreValue: "8.4", scoreLabel: "Overall", methodologyVersion: "v3.1", verified: null, verifiedAt: null }],
      neighborhoods: [{ neighborhoodKey: "neighborhood-1" as StoredDestinationState["neighborhoods"][number]["neighborhoodKey"], name: "Historic", summary: "Walkable", areaType: "urban", bestFor: null, walkabilityRating: null, safetyRating: null, transitRating: null, housingCharacter: null, pros: null, cons: null, googleMapsUrl: null }],
      ...
      media: [{ mediaKey: "media-1" as StoredDestinationState["media"][number]["mediaKey"], kind: "photo", url: "https://example.com/", caption: "View", altText: "Downtown", sourceName: null, sourceUrl: null, licenseNotes: null }],
      costOfLiving: [{ itemKey: "food", category: "Food", monthlyLow: "1000", monthlyHigh: "1500", currency: "USD", householdType: null, lifestyleTier: null, stayModeKey: null, verified: null, verifiedAt: null }],
      climateMonthly: [],
      ...
      lgbtqInclusivity: [],
      safetyRisks: [{ itemKey: "risk-1" as StoredDestinationState["safetyRisks"][number]["itemKey"], topic: "heat", severity: "moderate", summary: "Hot summers", verified: null, verifiedAt: null }],
      transportation: [],
      remoteWork: [],
      languageIntegration: [],
      pets: [],
